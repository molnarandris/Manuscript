...
public class Manuscript.PdfPane : Adw.Bin {
    ...
    construct {
        pdf_viewer.synctex_back.connect (do_synctex_backwards);
    }
    ...
    public void do_synctex_backwards(string path, int page, double x, double y) {
    ...
    private SourceLocation parse_synctex_result(string result_string) {
        ...
        MatchInfo match;
        regex.match (result_string, 0, out match);
